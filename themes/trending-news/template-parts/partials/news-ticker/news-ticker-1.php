...
if($walkerpress_focus_news_status){?>
	<div class="walkerwp-wraper ticker-news-wraper ticker-layout-2 trending-layout no-gap">
		<div class="walkerwp-container">
			
			<div class="news-ticker-box walkerwp-grid-12">
		    	<div class="swiper-container trendingnews-ticker-news">
							    ...
							    <div class="swiper-slide">
							    	...
							    	<?php
										...
										<div class="ticker-content">
											<h6>
												<a href="<?php echo the_permalink();?>" class="post-title"><?php  the_title(); ?></a>
											</h6>
			...
			<div class="trending-ticker-arrows">
				<div class="focus-arrows ticker-news-prev"><i class="fa fa-chevron-left" aria-hidden="true"></i></div>
			    <div class="focus-arrows ticker-news-next"><i class="fa fa-chevron-right" aria-hidden="true"></i></div>
			</div>
		</div>
	</div>
	<?php } ?>